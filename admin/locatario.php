        ...
        <?php include('sidebar.php') ?>
            ...
            <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
                <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
                    <h3 class="h3">Locatário</h3>
                    <div class="btn-toolbar mb-2 mb-md-0">

                        <a type="button" class="btn btn-md bg-bem-aqui-1 text-white" href="../admin/cadastro-cliente.php">
                ...
                <h5 class="h5">Lista de: Locatários</h5>
                <div class="table-responsive">
                    <table class="table table-striped table-sm">
                        ...
                        <tbody>
                            ...
                            foreach ($clientes->listaLocatarios() as $l) {
                            ?> <tr>
                                    <td><?php echo $l->nome ?></td>
                                    <td><?php echo $l->email ?></td>
                                    <td><?php echo $l->telefone ?></td>
                                    <td><?php echo $l->status_id ?></td>
                                    <td>
